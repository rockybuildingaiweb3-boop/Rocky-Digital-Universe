...
export default function KnowledgePage() {
  ...
  return (
    <main className="flex-1 flex flex-col items-center justify-center p-6 text-center max-w-2xl mx-auto">
      <div className="inline-flex items-center gap-2 px-3 py-1 mb-4 rounded-full border border-purple-500/30 bg-purple-500/10 text-purple-400 text-xs font-mono">
        <BookOpen className="w-3.5 h-3.5" />
        <span>WORLD 03 // KNOWLEDGE SYSTEM</span>
      </div>
